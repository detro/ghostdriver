 ...
 *
 * A {@link org.openqa.selenium.WebDriver} implementation that controls a PhantomJS running locally
 * GhostDriver. This class is provided as a convenience for easily testing PhantomJS. The control
 ...
 *
 * NOTE: <a href="https://github.com/detro/ghostdriver">GhostDriver</a> it's the PhantomJS Driver.
 * It's currently a separate project but will later on become one with PhantomJS, making the
 * requirement of the dedicated capability entry obsolete. Also, GhostDriver, being it a work in
 * progress, might rely on a specific version of PhantomJS: please read carefully the instructions
...
//   *
//   * @see org.openqa.selenium.phantomjs.PhantomJSDriverService#createDefaultService() for
...
//
//  /**
//   * Creates a new PhantomJSDriver instance, using a specific PhantomJSDriverService.
//   *
//   * @param service The PhantomJSDriverService to use.
//   */
