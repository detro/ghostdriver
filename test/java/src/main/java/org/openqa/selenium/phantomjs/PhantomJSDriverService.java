...
public class PhantomJSDriverService extends DriverService {
  ...
  /**
   * System property/capability that defines the location of the GhostDriver JavaScript launch
   * file (i.e. <code>"src/main.js"</code>)
   */
  ...
  String
      PHANTOMJS_DOC_LINK =
      "https://github.com/detro/ghostdriver/blob/master/README.md";
  private static final
  String
      PHANTOMJS_DOWNLOAD_LINK =
      "https://github.com/detro/phantomjs/tree/ghostdriver-dev";
  private static final
  String
      GHOSTDRIVER_DOC_LINK =
      "https://github.com/detro/ghostdriver/blob/master/README.md";
  private static final
  String
   ...
   * following capability, system property or PATH environment variables: <ul> <li>{@link
   * PhantomJSDriverService#PHANTOMJS_EXECUTABLE_PATH_PROPERTY}</li> <li>{@link
   * PhantomJSDriverService#PHANTOMJS_GHOSTDRIVER_PATH_PROPERTY}</li> </ul>
   *
   * Each service created by this method will be configured to find and use a free port on the
   * current system.
   *
   ...
   *
   * Looks into the Capabilities and the System Properties for {@link
   ...
   * @throws IllegalStateException If the executable not found or cannot be executed
   */
  protected static File findGhostDriver(Capabilities desiredCapabilities, String docsLink,
                                        String downloadLink) {
